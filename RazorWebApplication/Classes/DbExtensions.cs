...
namespace RandomSongSearchEngine.Classes
{
    ...
    public static class DbExtensions
    {
        ...
        /// <returns></returns>
        public static IQueryable<Tuple<string, int>> CreateCheckboxesDataSql(this RazorDbContext database)//
        {
        ...
        /// <returns></returns>
        public static IQueryable<int> CreateSongsListRandomizerSql(this RazorDbContext database, int[] chosenOnes)
        {
        ...
        /// <returns></returns>
        public static IQueryable<Tuple<string, int>> CreateSongsDataCatalogViewSql(this RazorDbContext database, int savedLastViewedPage, int pageSize)
        {
        ...
        /// <returns></returns>
        public static IQueryable<Tuple<string, string>> CreateTitleAndTextSql(this RazorDbContext database, int textId)
        {
        ...
        /// <returns></returns>
        public static IQueryable<int> CreateCheckedListChangeViewSql(this RazorDbContext database, int savedTextId)
        {
        ...
        /// <returns></returns>
        public static async Task ChangeSongInDatabaseAsync(this RazorDbContext db, List<int> initialCheckboxes, DataTransfer dt)
        {
        ...
        public static async Task<int> AddSongToDatabaseAsync(this RazorDbContext db, DataTransfer dt)
        {
            using (IDbContextTransaction t = await db.Database.BeginTransactionAsync())
            {
                try
        ...
        public static void CheckNameExistsError(this RazorDbContext db, string title)
        {
            int r = db.Text
        ...
        public static void CheckGenresExistsError(this RazorDbContext db, int savedTextId, HashSet<int> forAddition)
        {
